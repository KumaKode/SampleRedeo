              ...
              <div className="jm-candidate-profile-overview-portion">
                ...
                <ul className="jm-job-sidebar-review-list mb-15">
                  <li>
                    ...
                    <span className="jm-job-review-label">Title : </span> UI
                    Designer
                  </li>
                  <li>
                    <i className="fa-light fa-transgender"></i>{" "}
                    <span className="jm-job-review-label">Gender : </span> Male
                  </li>
                  <li>
                    <i className="fa-thin fa-heart"></i>{" "}
                    <span className="jm-job-review-label">Experience : </span>{" "}
                    02 Years
                  </li>
                  <li>
                  ...
                  <li>
                    <i className="fa-thin fa-timer"></i>{" "}
                    <span className="jm-job-review-label">Posted : </span> 2
                    Hours Ago
                  </li>
                  <li>
                    <i className="fa-thin fa-location-crosshairs"></i>{" "}
                    <span className="jm-job-review-label">Location : </span> New
                    York, USA
                  </li>
                </ul>
            ...
            <div className="jm-candidate-content-wrapper mb-40">
              ...
              <div className="jm-candidate-content-education">
                <div className="jm-candidate-content-education-item">
                  ...
                  <div className="jm-candidate-content-education-inner">
                    <span className="jm-candidate-experience-date">
                      Speeddigit Software Solution <span>(2012 - 2014)</span>
                    </span>
                  ...
                  <div className="jm-candidate-content-education-inner">
                    <span className="jm-candidate-experience-date">
                      Speeddigit Software Solution <span>(2014 - 2018)</span>
                    </span>
                    <h5 className="jm-candidate-content-inner-sm-title">
                      Senior Engineer
                    </h5>
                    <p>
                      ...
                      shedding these non-supportive beliefs and replacing them
                      with beliefs that will help them to accomplish their
                      desires.
                    </p>
                  </div>
                  <div className="jm-candidate-content-education-inner">
                    <span className="jm-candidate-experience-date">
                      Speeddigit Software Solution <span>(2018 - 2022)</span>
                    </span>
                    <h5 className="jm-candidate-content-inner-sm-title">
                      Product Manager
                    </h5>
                ...
                <div className="jm-candidate-content-education-item">
                  ...
                  <div className="jm-candidate-content-education-inner">
                    <span className="jm-candidate-experience-date">
                      International University <span>(2008 - 2010)</span>
                    </span>
                    <h5 className="jm-candidate-content-inner-sm-title">
