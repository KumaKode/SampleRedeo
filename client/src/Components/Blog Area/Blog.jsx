              ...
              <div className="jm-blog-item-content">
                <div className="jm-blog-item-content-meta-3">
                  ...
                  <div className="jm-comment-3">
                    <Link to="#">
                      <i className="fa-thin fa-comment"></i>2 Comments
                    </Link>
                  </div>
                </div>
                <h4 className="jm-blog-title">
                  <Link to="/blogDetailsPage">
                    How to Work Instagram Marketing
                  </Link>
                </h4>
                <Link to="/blogDetailsPage" className="read-more theme-btn-jm">
          ...
          <div className="col-xl-4 col-lg-4 col-md-6">
            <div className="jm-blog-item jm-blog-layout-2 mb-55">
              ...
              <div className="jm-blog-item-content">
                ...
                <h4 className="jm-blog-title">
                  <Link to="/blogDetailsPage">
                    Nike Shoes Attract More For Sales
                  </Link>
                </h4>
                <Link to="/blogDetailsPage" className="read-more theme-btn-jm">
                  Read More <i className="fa-thin fa-arrow-right-long"></i>
